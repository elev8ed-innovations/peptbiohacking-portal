  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0A1628' }}>
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '32px 20px' }}>
        <h1 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '36px', color: '#fff', margin: '0 0 8px' }}>
          {t.patientList}
        </h1>
        ...
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: '60px', color: 'rgba(255,255,255,0.4)', fontFamily: 'Outfit, sans-serif' }}>
            {t.noPatients}
          </div>
        ) : (
              ...
              <div key={patient.id} style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                    ...
                    <div>
                      <div style={{ color: '#fff', fontFamily: 'Outfit, sans-serif', fontWeight: 600, fontSize: '16px' }}>
                        {patient.full_name || 'Unnamed Patient'}
                      </div>
                      <div style={{ color: 'rgba(255,255,255,0.4)', fontFamily: 'Outfit, sans-serif', fontSize: '13px' }}>
                        {patient.email}
                      </div>
                    </div>
                  </div>
                  ...
                  <div style={{ display: 'flex', gap: '10px' }}>
                    <button
                      ...
                      style={{
                        padding: '8px 18px',
                        background: generating[patient.id] ? 'rgba(201,168,76,0.1)' : 'rgba(201,168,76,0.15)',
                ...
                {summaries[patient.id] && (
                  <div style={{
                    ...
                    <p style={{ color: 'rgba(255,255,255,0.85)', fontFamily: 'Outfit, sans-serif', fontSize: '14px', lineHeight: '1.6', margin: 0, whiteSpace: 'pre-wrap' }}>
                      {summaries[patient.id]}
                    </p>
                  </div>
                )}
